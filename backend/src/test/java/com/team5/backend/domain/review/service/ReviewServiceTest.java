...
class ReviewServiceTest {
    ...
    void getReviewsByProductId_latestSorted() {
        ...
        when(reviewRepository.findByProduct_ProductId(eq(1L), any(Pageable.class))).thenReturn(reviewPage);
    ...
    void getReviewsByMemberId() {
        Pageable pageable = PageRequest.of(0, 5);
        Page<Review> page = new PageImpl<>(List.of(review));
        when(reviewRepository.findByMember_MemberId(eq(1L), any(Pageable.class))).thenReturn(page);
