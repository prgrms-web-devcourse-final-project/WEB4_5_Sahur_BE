...
public class NotificationController {
    ...
    @PostMapping
    public ResponseEntity<NotificationResDto> createNotification(
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<NotificationResDto> patchNotification(
            @Parameter(description = "알림 ID") @PathVariable Long id) {
    ...
    public ResponseEntity<Page<NotificationResDto>> getNotificationsByMemberId(
