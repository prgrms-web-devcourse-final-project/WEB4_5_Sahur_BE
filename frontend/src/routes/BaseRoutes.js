...
import AdminProductsRequestDetail from "../pages/admin/products/AdminProductsRequestDetail";
...
import AdminRouteGuard from "../shared/AdminRouteGuard";
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route
          path="products/requests/:productId"
